...
- Two-sample KS does **not** reject equality (p ≈ 0.3) — but this reflects the small
  25-spacing strata sample, **not** true identity.
- The large zero sample reveals a real difference: **Gubbio is systematically more
  rigid** (Δ⟨r⟩ = +0.11), closer to a perfect lattice — exactly as astronomical
  quasi-periodic forcing predicts.
...
But they are **not pointwise identical**: the strata are more rigid. Sharing a
...
│   └── gubbio_real.csv        real Gubbio susceptibility (PANGAEA 864450)
